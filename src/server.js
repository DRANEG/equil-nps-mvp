...
const ROUTES = [
  ...
  ['GET', '/confidentialitate', pub.privacy],
  ['POST', '/sterge-date/:token', pub.eraseMyData],
  ...
  ['GET', '/admin/date-personale', admin.personalData, true],
  ['GET', '/admin/date-personale/export', admin.personalDataExport, true],
  ['POST', '/admin/date-personale/sterge', admin.personalDataDelete, true],
  ['POST', '/admin/date-personale/retentie', admin.personalDataRetention, true],
